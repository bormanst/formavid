...
<div>
  ...
  <ul>
    ...
    <ul>
      ...
      <li>Compare /etc/apache2/sites-available/SITEHOSTNAME.conf to the original template /usr/local/formavid/sites-template/sitehostname.conf.</li>
    ...
    <ul>
      <li>Copy /usr/local/formavid/sites-template/sitehostname.conf into /etc/apache2/sites-available.</li>
